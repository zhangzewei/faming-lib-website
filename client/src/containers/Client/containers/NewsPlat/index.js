...
export default class NewsPlat extends Component {
  ...
  render() {
    const list = [
      {title: '农业部杂粮加工重点实验室、国家杂粮加工技术研发分中心、成都市荞麦产业化工程技术研究中心根据我国杂粮产业的发展需要，以成都大学为依托而组建。', date: '2017-8-21',link:'/secondPage/news/LibMenu:lingdao/lingdao'},
      {title: '近年来主持国家科技部、农业部及省级多项科研课题。主持获得省部级科技进步一等奖一项、二等奖五项，获国家级教学成果二等奖一项、省级教学一、二、三等奖共计六项。选育苦荞麦新品种', date: '2017-12-6',link:'/secondPage/news/LibMenu:lingdao/lingdao'},
      {title: '实验室实行主任负责制，设立实验室主任一人，副主任三人，并下设', date: '2017-10-30',link:'/secondPage/news/LibMenu:lingdao/lingdao'},
      ...
      {title: '与湖北劲牌保健酒业有限公司、四川环太实业有限责任公司等多家省内外荞麦生产领域的企业强强联合', date: '2018-3-2',link:'/secondPage/news/LibMenu:lingdao/lingdao'},
